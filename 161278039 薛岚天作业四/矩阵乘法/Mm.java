...
public class Mm {
  ...
  public static class MatrixMapper extends Mapper<Object, Text, Text, Text> {
    ...
    //use conf.get() to get value of row number and column number
    ...
    public void map(Object key, Text value, Context context)
      ...
      //use file name to discriminate M and N
      FileSplit fileSplit = (FileSplit) context.getInputSplit();
      String fileName = fileSplit.getPath().getName();

      if (fileName.contains("M")) {
        String[] tuple = value.toString().split(",");
        //get locations and values of elements
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 3) {
      ...
      int k=Integer.parseInt(infoTupleN[1]);
      if(k!=columnM) {
    	  System.err.println("cannot multiple the two matrix");
    	  System.exit(2);
      }//if the col number of the 1st matrix does not equal to the row number of the 2nd matrix, error
